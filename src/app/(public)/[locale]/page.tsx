    ...
    <>
      ...
      <section className="relative flex min-h-screen items-end overflow-hidden pb-24">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6">
          <p className="mb-5 text-xs font-semibold uppercase tracking-[0.2em] text-ck-red">
            {t('hero.eyebrow')}
          </p>
          <h1
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/offerte"
              className="group inline-flex items-center gap-2 bg-ck-red px-7 py-4 text-sm font-semibold uppercase tracking-wider text-white transition-all duration-200 hover:bg-ck-red-hover hover:-translate-y-0.5 hover:shadow-lg hover:shadow-ck-red/30"
            >
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {([
              ...
              <div key={value} className="flex flex-col gap-1">
                <span
                  className="font-heading font-extrabold leading-none text-ck-red"
      ...
      <section className="py-24 bg-ck-bg">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 overflow-hidden border border-ck-border transition-colors duration-300 hover:border-ck-red/40 md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center bg-ck-surface p-8 md:p-12">
                ...
                <h3
                  className="font-heading font-bold text-ck-text"
                ...
                <p className="mt-4 border-l-2 border-ck-red pl-4 text-sm text-ck-text-faint">
            ...
            <div className="grid grid-cols-1 overflow-hidden border border-ck-border transition-colors duration-300 hover:border-ck-red/40 md:ml-12 md:grid-cols-2">
            ...
            <div className="grid grid-cols-1 overflow-hidden border border-ck-border transition-colors duration-300 hover:border-ck-red/40 md:mr-12 md:grid-cols-2">
              <div className="relative h-64 overflow-hidden md:h-auto md:min-h-[260px]">
                <Image
      ...
      <section className="border-y border-ck-border bg-ck-surface py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-ck-red">
              ...
              <div className="mt-8">
                <Link
                  href="/gallerij"
                  className="inline-flex items-center gap-2 bg-ck-red px-7 py-4 text-sm font-semibold uppercase tracking-wider text-white transition-all duration-200 hover:bg-ck-red-hover hover:-translate-y-0.5"
                >
            ...
            <div className="relative overflow-hidden border border-ck-border">
              <div className="relative flex h-80">
                ...
                <div className="w-px bg-ck-border" />
                <div className="relative flex-1">
                  <Image
                    src="/images/before-after.webp"
                    alt=""
                    ...
                    sizes="(min-width: 1024px) 25vw, 50vw"
                  />
                  <span className="absolute bottom-4 right-4 bg-ck-red px-3 py-1.5 text-xs font-semibold uppercase tracking-widest text-white">
                    {t('gallery.after')}
                  </span>
                </div>
              </div>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {(['one', 'two', 'three'] as const).map((key) => (
              <div key={key} className="border border-ck-border bg-ck-surface p-8">
                <div className="mb-4 text-ck-red">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <a href="tel:+31681631020" className="group flex items-center gap-4">
                <span
                  className="font-heading font-extrabold text-white transition-colors duration-200 group-hover:text-ck-red"
