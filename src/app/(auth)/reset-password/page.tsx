    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-lg font-medium text-white">{t('resetTitle')}</h1>
          <p className="mt-1 text-sm text-[#6b6b80]">{t('resetSubtitle')}</p>
        </div>

        {sent ? (
          <div className="rounded-[10px] border-[0.5px] border-[#1e1e2a] bg-[#12121a] p-4 text-center">
            <p className="text-sm text-white">{t('resetEmailSent')}</p>
            <a
              href="/login"
              className="mt-3 inline-block text-sm text-[#E8364E] transition-opacity hover:opacity-80"
            >
              {t('backToLogin')}
            </a>
          </div>
