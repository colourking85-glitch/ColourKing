    ...
    screens: [
      {
        ...
        inputs: 'Offer (optional, approved only), customer (required), vehicle (required), job type, priority, payer type, assigned technician, estimated hours, target date, intake km, notes. Process rows: title and estimated hours.',
        outputs: 'New job record plus one Task (TS) per process row. Redirects to Job Detail (JB10).',
        crossScreen: 'Offer dropdown shows approved offers from ES10. Customer/vehicle from KL/VH. Technician from Staff (SY02). Created tasks appear in My Tasks (TS05). Job appears in Job List (JB05) and Board (JB15).',
      },
      {
        code: 'JB05',
