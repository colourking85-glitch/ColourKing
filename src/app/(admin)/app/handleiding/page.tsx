...
const MODULES = [
  ...
  },
  {
    ...
    screens: [
      {
        code: 'SY01',
        agentNotes: 'Client-side settings stored in localStorage/cookies. Three tabs: appearance, general, notifications. Nav group collapse state persisted. Header bar: ScreenBadge auto-detects current screen code from pathname (including dynamic [id] routes). Command palette (Ctrl+K / ⌘K) searches all registered screen codes — static routes are navigable, dynamic routes (e.g. IN15, LD10) appear as non-clickable references. getScreen() resolves UUIDs and numeric path segments to [id] patterns.',
        ...
        crossScreen: 'Language setting affects all screens. Notification toggles affect Monitoring (SY05). Accent colour changes button and badge colours throughout. Nav group state applies to sidebar navigation. Screen badge system uses SCREEN_REGISTRY from lib/codes.ts — all screens must be registered there.',
      },
      {
        code: 'SY02',
