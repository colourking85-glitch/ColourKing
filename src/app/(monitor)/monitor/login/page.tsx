    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f]">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <h1 className="font-display text-2xl font-bold text-white">Colourking Monitor</h1>
          <p className="mt-1 text-sm text-[#6b6b80]">Log in om de monitoring te openen</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-[#6b6b80]">E-mailadres</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="mb-1 block text-xs text-[#6b6b80]">Wachtwoord</label>
            <input
              type="password"
              value={password}
