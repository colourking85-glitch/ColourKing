          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-lg border border-[#1e1e2a] bg-[#12121a] px-4 py-2.5 pr-11 text-sm text-white placeholder:text-[#3a3a50] focus:border-[#E8364E] focus:outline-none"
                placeholder="••••••••"
              />
              <button
                type="button"
